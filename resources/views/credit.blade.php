...
{{-- <?php  dd($credit);?> --}}
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control-file" id="final_uplod" name="final_uplod"
                                            accept=".xlsx,.xls">
                        ...
                        <tbody>
                            <tr>
                                <td><button type="button" class="btn btn-link"
                                        onclick="fetchLoanData('viewapplication')"><i class="fas fa-eye"></i></button> View
                                    Application</td>
                                <td><button type="button" class="btn btn-link" onclick="fetchLoanData('viewdocument1')"><i
                                            class="fas fa-eye"></i></button> View Document</td>
                                <td><button type="button" class="btn btn-link" onclick="fetchLoanData('viewcam')"><i
                                            class="fas fa-eye"></i></button> View CAM</td>
                                <td><button type="button" class="btn btn-link" id="adddesicion"><i
                                            class="fa fa-plus mr-2"></i>Add</button></td>
            ...
            <div class="col-lg-12">
                <h6 style="font-weight: 700">Credit Data</h6>
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th>Final Uplod</th>
                    ...
                    <tbody> 
                        ...
                        <tr>
                            {{-- <td>
                                @if($credi->final_uplod) 
                              
                               
                                    <a href="{{ asset('storage/documents/credit/' . $credi->final_uplod) }}" class="btn btn-success btn-sm" target="_blank">
                            ...
                            <td>
                                @if($credi->final_uplod) <!-- Check if a file exists -->
                                    <div>
                                        <!-- Display the file name -->
                                        <span>{{ $credi->final_uplod }}</span>
                                    </div>
                                    <a href="{{ asset('storage/documents/credit/' . $credi->final_uplod) }}" class="btn btn-success btn-sm" target="_blank">
                                        <i class="fas fa-download"></i> Download
                                    </a>
                            ...
                            <td>
                                {{-- <a href="{{ route('delete-credit', $credi->id) }}" class="btn btn-primary btn-sm">
                                    <i class="fas fa-trash-alt"></i> Delete
                                </a> --}} 
                                <form action="{{ route('delete-credit', $credi->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="requested_amount"
                                                    id="requested_amount" placeholder="Requested Amount" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="formGroupExampleInput4">Requested Tenure(Months)</label>
                                                <input type="text" class="form-control" name="requested_tenure"
                                                    id="requested_tenure" placeholder="Requested Tenure(Months)" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="formGroupExampleInput4">Sanctioned Amount</label>
                                                <input type="text" class="form-control" name="sanctioned_amount"
                                                    id="sanctioned_amount" placeholder="Sanctioned Amount">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Row 3 -->
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="sanctioned_tenure"
                                                    id="sanctioned_tenure" placeholder="Sanctioned Tenure(Months)">
                                            </div>
                                        </div>
                                        {{-- <div class="col-md-4">
                                        <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    <div class="form-check form-check-inline" style="margin-left:-20px;">
                                                        <input class="form-check-input" type="radio"
                                                            name="sanctionedInterest" id="sanctionedInterest1"
                                                            value="8">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="sanctionedInterest" id="sanctionedInterest2"
                                                            value="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="policyrate"
                                                    id="policyrate" placeholder="Policy Rate" readonly>
                                            </div>
                                        </div>
                                        {{-- <div class="col-md-4">
                                        <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="applicable_rate"
                                                    id="applicable_rate" placeholder="Applicable Rate" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="application"
                                                            id="ApproveConditions" value="Approve"
                                                            onclick="toggleReasonTextarea(this)">
                                                        <label class="form-check-label"
                                                            for="ApproveConditions">Approve</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="application"
                                                ...
                                                <div id="reason-textarea-container"
                                                    style="display: none; margin-top: 10px;">
                                                    <label for="reason-textarea" id="reason-label"></label>
                                                    <textarea class="form-control" id="reason-textarea" name="reason" rows="3"
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, item) {
                        ...
                        if (item.proprietor_id && item.proprietor_name && !selectedValues[
                                item.proprietor_id]) {
                            $('#customer_id').append($('<option>', {
                                value: item.proprietor_id,
                                text: item.proprietor_name + ' (Proprietor)'
                            }));
                            selectedValues[item.proprietor_id] =
                                true; // Mark proprietor as added
                        }
                    });
                        ...
                        if (data && Object.keys(data).length >
                            ...
                            if (data.sanctionedInterest === "8") {
                                ...
                                $("#sanctionedInterest2").prop("checked", true).val(data
                                    .sanctionedInterest);
                                $('#policyrate').val(data.sanctionedInterest).prop(
                                    'readonly', false);
                            }
                            ...
                            if (data.reason) {
                                $("#reason-textarea-container")
                                    .show(); // Show the textarea container
                                $("#reason-textarea").val(data
                                    .reason); // Set the value in the textarea
                            } else {
                                $("#reason-textarea-container")
                                    .hide(); // Hide the textarea if no reason is available
