                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="relation_type"
                                                        ...
                                                        <option value="Yes"
                                                            {{ isset($Proprietordata->applying_as_co_borrower) && $Proprietordata->applying_as_co_borrower == 'Yes' ? 'selected' : '' }}>
                                                            Yes</option>
                                                        <option value="No"
                                            ...
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control address"
                                                        ...
                                                        value="{{ isset($Proprietordata->Current_Residence_Address) ? $Proprietordata->Current_Residence_Address : old('Current_Residence_Address') }}">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control per-landmark"
                                                        ...
                                                        value="{{ isset($Proprietordata->Current_Landmark) ? $Proprietordata->Current_Landmark : old('Current_Landmark') }}">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control pincode-input"
                                                        ...
                                                        name="pincode[]"
                                                        value="{{ isset($Proprietordata->Current_pincode) ? $Proprietordata->Current_pincode : old('Current_pincode') }}">
                                                    @error('pincode')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group d-flex align-items-center">
                                                    <div class="form-check ml-2 mr-2">
                                                        <input type="radio" class="form-check-input" id="peryes{{ $index }}"
                                                            onClick="getperaddress(this)" name="proof_address[{{ $index }}]"
                                                            value="{{ $value }}"
                                                            {{ old('proof_address.'.$index) == $value ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="peryes{{ $index }}">{{ $value }}</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" id="perno{{ $index }}"
                                                            onClick="getperaddress(this)" name="proof_address[{{ $index }}]"
                                                            value="No"
                                                            {{ old('proof_address.'.$index) == 'No' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="perno{{ $index }}">No</label>
                                                    </div>
                                                </div>
                                                @error('proof_address')
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control per_city" id="per_city"
                                                        name="per_city[]">
                                                    </select>
                                                    @error('per_city')
                                                        <span class="text-danger">{{ $message }}</span>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control per_district"
                                        ...
                                        <div class="row mb-1">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="f_s_name"
                                                        name="f_s_name[]"
                                                        value="{{  old('father_or_spouse_name') }}">
                                                    @error('f_s_name')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="mobile"
                                                        name="mobile[]"
                                                        value="{{  old('proprietor_Mobile_no') }}">
                                                    @error('mobile')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="pan"
                                                        name="pan[]"
                                                        value="{{ old('proprietor_pannumber') }}">
                                                    @error('pan')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="adhar"
                                                        name="adhar[]"
                                                        value="{{  old('proprietor_adharnumber') }}">
                                                    @error('adhar')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
...
<script>
    ...
    function getcloneaddress(input) {
        var val = $(input).val();
        ...
        if (val === 'perYes') {
            ...
            $(".clone_permanent_address").prop('readonly', false);
            $(".landmark").prop('readonly', false);
            $(".pincode-input1").prop('readonly', false);
            $(".clone_per_city").prop('readonly', false);
            $(".clone_per_District").prop('readonly', false);
            $(".clone_per_State").prop('readonly', false);
            $(".clone_per_state_code").prop('readonly', false);
            $(".clone_per_country_code").prop('readonly', false);

            $(".clone_permanent_address").val('');
            $(".clone_pincode-input1").val('');
            $(".clone_per_city").val('');
            $(".clone_per_District").val('');
            $(".clone_per_State").val('');
            $(".clone_per_state_code").val('');
            $(".clone_per_country_code").val('');
                                    ...
                                    <div class="row mb-1">
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <label for="current_address" class="text-nowrap">Current Residence
                                                    Address</label>
                                                <input type="text" class="form-control address" id="clone_current_address"
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label for="pincode" class="text-nowrap">Pin/Post Code</label>
                                                <input type="text" class="form-control pincode-input" id="clone_pincode"
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label for="city" class="text-nowrap">City/ Town</label>
                                                <select class="form-control city" id="clone_city" name="city[]">
                                                </select>
                                                @error('city')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label for="District" class="text-nowrap">District</label>
                                                <input type="text" class="form-control district" id="clone_District"
                                                    name="District[]"
                                                    value="">
                                                @error('District')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label for="State" class="text-nowrap">State</label>
                                                <input type="text" class="form-control state" id="clone_State"
                                                    name="State[]"
                                                    value="">
                                                @error('State')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label for="state_code" class="text-nowrap">State/UT code</label>
                                                <input type="text" class="form-control state-code" id="clone_state_code"
                                                    name="state_code[]"
                                                    value="">
                                                @error('state_code')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label for="country_code" class="text-nowrap">ISO Country Code</label>
                                                <input type="text" class="form-control country-code" id="clone_country_code"
                                                    name="country_code[]"
                                                    value="">
                                                @error('country_code')
                                                    <span class="text-danger">{{ $message }}</span>
                                            ...
                                            <div class="form-group d-flex align-items-center">
                                                <div class="form-check ml-2 mr-2">
                                                    <input type="radio" class="form-check-input" id="peryes"
                                                        onClick="getcloneaddress(this)" name="proof_address[]"
                                                        value="perYes">
                                                    <label class="form-check-label" for="yes">Yes</label>
                                                </div>
                                                <div class="form-check">
                                    ...
                                    <div class="row mb-1">
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <label for="per_address" class="text-nowrap">Permanent Residence
                                                    Address</label>
                                                <input type="text" class="form-control clone_permanent_address"
                                                    id="per_address" name="per_address[]"
                                                    value="">
                                                @error('per_address')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="per_landmark" class="text-nowrap">Landmark</label>
                                                <input type="text" class="form-control clone_landmark" id="per_landmark"
                                                    name="per_landmark[]"
                                                    value="">
                                                @error('per_landmark')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label for="per_pincode" class="text-nowrap">Pin/Post Code</label>
                                                <input type="text" class="form-control clone_pincode-input1"
                                                    id="per_pincode" onInput="checkPincodeLength1(this)"
                                                    name="per_pincode[]"
                                                    value="">
                                                @error('per_pincode')
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label for="per_city" class="text-nowrap">City/ Town</label>
                                                <select class="form-control clone_per_city" id="per_city" name="per_city[]">
                                                </select>
                                                @error('per_city')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label for="per_District" class="text-nowrap">District</label>
                                                <input type="text" class="form-control clone_per_district" id="per_District"
                                                    name="per_District[]"
                                                    value="">
                                                @error('per_District')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label for="per_State" class="text-nowrap">State</label>
                                                <input type="text" class="form-control clone_per_state" id="per_State"
                                                    name="per_State[]"
                                                    value="">
                                                @error('per_State')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label for="per_state_code" class="text-nowrap">State/UT code</label>
                                                <input type="text" class="form-control clone_per_state_code"
                                                    id="per_state_code" name="per_state_code[]"
                                                    value="">
                                                @error('per_state_code')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control clone_per_country_code"
                                                    id="per_country_code" name="per_country_code[]"
                                                    value="">
                                                @error('per_country_code')
                                                    <span class="text-danger">{{ $message }}</span>
