                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control city-{{ $index }}" id="city"
                                                        name="city[]">
                                                        <option value="">{{ $Proprietordata->Current_City }}</option>
                                                    </select>
                                                    @error('city')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                ...
                                                <div class="form-group d-flex align-items-center">
                                                    <div class="form-check ml-2 mr-2">
                                                        <input type="radio" class="form-check-input"
                                                            ...
                                                            data-index="{{ $index }}"
                                                            name="proof_address[{{ $index }}]" value="Yes"
                                                            {{ old('proof_address') }}> Yes
                                                    ...
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input"
                                                            ...
                                                            data-index="{{ $index }}" value="No"
                                                            {{ old('proof_address') }}>No
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control state-code" id="state_code"
                                                    name="state_code[]" value="{{ old('Current_State_code') }}">
                                                @error('state_code')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control landmark" id="per_landmark"
                                                    name="per_landmark[]" value="{{ old('Permanent_Landmark') }}">
                                                @error('per_landmark')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
...
<script>
    ...
    function getperaddress(input) {
        ...
        // $(`.clone_permanent_address_${index}`).prop('readonly', true);
        //alert(val);  
        // alert(index);
        // if (val === 'Yes') {
        //     // alert('yes');
        ...
        //     var city = $("#city").val();
        //     var district = $("#per_District").val();
        //     var state = $('input[name="State[]"]').val();
        //     var state_code = $("#per_state_code").val();
        //     var country_code = $("#per_country_code").val();
        ...
        //     $(".clone_per_country_code").prop('readonly', true);
        //     // var cloneaddress = $("#clone_current_address").val(); 
        //     var cloneAddress = $("#clone_current_address_" + index).val();
        //     var clonelandmark = $("#clone_current_landmark").val();
        //     var clonepincode = $("#clone_pincode").val();
        //     var clonecity = $("#clone_city").val();
        //     var clonedistrict = $("#clone_District").val();
        ...
        //     var clonecountry_code = $("#clone_country_code").val();
        //     console.log(cloneAddress); 
        //     // console.log(clonelandmark);
        //     // console.log(clonedistrict);
        //     // $(".clone_permanent_address").val(cloneaddress); 
        //     $(".clone_permanent_address_" + index).val(cloneAddress);
        //     $(".clone_landmark").val(clonelandmark);
        //     $(".clone_pincode-input1").val(clonepincode);
        //     $(".clone_per_District").val(clonedistrict);
        //     $(".clone_per_State").val(clonestate);
        ...
        //     // alert('perNo');
        //     $(".clone_permanent_address").prop('readonly', false);
        //     $(".per-landmark").prop('readonly', false);
        //     $(".pincode-input1").prop('readonly', false);
        //     $(".clone_per_city").prop('readonly', false);
        //     $(".clone_per_District").prop('readonly', false);
        //     $(".clone_per_State").prop('readonly', false);
